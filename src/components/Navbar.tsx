  ...
  return (
    <nav style={{
      ...
      <div style={{
        ...
        {/* Laptop / desktop nav (hidden on mobile & tablet — see <style> breakpoint) */}
      ...
      {/* Slide-down menu (mobile + tablet when hamburger is used) */}
      {mobileOpen && (
      ...
      <style>{`
        ...
        /* <1024px: hamburger (phones unchanged; tablets match this). ≥1024px: full nav row. */
