...
export default function Footer() {
  return (
    <footer className="w-full bg-brand-900 text-brand-300">
      ...
      {/* Main Grid */}
      <div className="max-w-7xl mx-auto py-16 px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
        {/* Brand */}
        ...
        {/* Links columns */}
        {[{ title: "Company", links: footerLinks.company }].map(({ title, links }) => (
          <div key={title}>
