    ...
    <main style={{ minHeight: "100vh", background: "#fdf9f7" }}>
      ...
      <div style={{ background: "#ffffff", borderBottom: "1px solid #ede8e3", padding: "80px 24px 56px", textAlign: "center" }}>
        <div style={{ maxWidth: "720px", margin: "0 auto" }}>
          ...
          {/* Category chips (single row — wraps on small screens) */}
      ...
      <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "32px 24px 80px" }}>
        ...
        {/* ── Toolbar (sort + count only — category chips stay in hero above) ── */}
        <div style={{ display: "flex", alignItems: "center", justifyContent: "flex-end", gap: "12px", marginBottom: "28px", flexWrap: "wrap" }}>
