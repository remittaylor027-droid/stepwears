                ...
                return (
                  <div key={stat.key}>
                    <div style={valueStyle}>
                      {stat.kind === "range" ? (
                        <>
                          <CountUp from={stat.from} to={stat.toLow} duration={stat.duration} delay={delay} />
                          <span style={{ fontWeight: 900 }}>{"\u2013"}</span>
                          <CountUp from={stat.from} to={stat.toHigh} duration={stat.duration} delay={delay} />
                        </>
                      ) : (
                        <>
                          <CountUp from={stat.from} to={stat.to} duration={stat.duration} delay={delay} />
                          {stat.suffix ? (
                    ...
                    <div style={{
                      fontSize: "0.62rem", color: "#c0a090", fontWeight: 700,
